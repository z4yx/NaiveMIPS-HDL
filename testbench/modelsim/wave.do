...
add wave -noupdate /test/mips/stage_ex/overflow
add wave -noupdate -divider ex-mm
add wave -noupdate -radix hexadecimal /test/mips/hilo/rdata
add wave -noupdate -radix hexadecimal /test/mips/mm_data_o
add wave -noupdate -divider mm-wb
add wave -noupdate /test/mips/stage_wb/reg_we
...
WaveRestoreCursors {{Cursor 1} {30900 ns} 0}
...
update
WaveRestoreZoom {16500 ns} {53500 ns}
