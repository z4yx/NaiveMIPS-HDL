...
add wave -noupdate /test/soc/dbus_address
add wave -noupdate -radix binary /test/soc/dbus_rddata
add wave -noupdate -divider UART
add wave -noupdate /test/soc/clk_uart
add wave -noupdate /test/uart_line
...
add wave -noupdate -radix binary /test/ram_dataenable
...
WaveRestoreCursors {{Cursor 1} {779071491 fs} 0}
...
update
WaveRestoreZoom {249565217 fs} {469962785 fs}
