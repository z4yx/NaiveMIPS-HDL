...
add wave -noupdate /test/soc/dbus_read
add wave -noupdate /test/soc/dbus_write
add wave -noupdate /test/soc/dbus_stall
add wave -noupdate /test/soc/gpio_dbus_read
add wave -noupdate /test/soc/gpio_dbus_write
...
add wave -noupdate /test/soc/sram0/brust
...
WaveRestoreCursors {{Cursor 1} {17511348143 fs} 0}
...
update
WaveRestoreZoom {12574734790 fs} {18285540274 fs}
