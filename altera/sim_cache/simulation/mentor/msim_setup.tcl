...
# ----------------------------------------
# ACDS 15.1 185 win32 2016.06.05.01:18:24
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/sim_cache_onchip_memory2_0.hex ./
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/sim_cache_onchip_memory2_0.v"                                                                  -work onchip_memory2_0                  
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L router_001 -L router -L rsp_mux -L cmd_mux -L cmd_demux -L avalon_st_adapter -L onchip_memory2_0_s1_burst_adapter -L onchip_memory2_0_s1_agent_rsp_fifo -L onchip_memory2_0_s1_agent -L Cache_0_burst_master_agent -L onchip_memory2_0_s1_translator -L Cache_0_burst_master_translator -L rst_controller -L mm_interconnect_2 -L mm_interconnect_1 -L mm_interconnect_0 -L onchip_memory2_0 -L master_data -L Cache_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
