...
# ACDS 15.1 185 win32 2016.07.19.12:00:31
...
# # End of template
# ----------------------------------------
# If pll_hf is one of several IP cores in your
...
TOP_LEVEL_NAME="pll_hf"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="E:/software/altera/15.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_hf.vo"
fi
