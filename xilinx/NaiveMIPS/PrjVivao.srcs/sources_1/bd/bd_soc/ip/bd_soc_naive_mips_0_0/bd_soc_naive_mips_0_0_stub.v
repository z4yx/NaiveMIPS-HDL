...
module bd_soc_naive_mips_0_0(debugger_uart_txd, ibus_address, 
  ...
  dbus_read, dbus_write, dbus_uncached_read, dbus_uncached_write, dbus_wrdata, 
  dbus_uncached_stall, dbus_uncached, dbus_dcache_inv_wb, dbus_icache_inv, rst_n, clk, 
  debugger_uart_rxd, debugger_uart_clk, ibus_rddata, ibus_stall, dbus_rddata, 
  dbus_rddata_uncached, dbus_stall, hardware_int_in)
