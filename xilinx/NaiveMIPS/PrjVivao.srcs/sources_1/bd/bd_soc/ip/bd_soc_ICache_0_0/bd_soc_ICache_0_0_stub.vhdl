...
--               /home/zhang/NaiveMIPS-HDL/xilinx/NaiveMIPS/PrjVivao.srcs/sources_1/bd/bd_soc/ip/bd_soc_ICache_0_0/bd_soc_ICache_0_0_stub.vhdl
...
entity bd_soc_ICache_0_0 is
  Port ( 
    ...
    dbus_rdaddr : in STD_LOGIC_VECTOR ( 31 downto 0 );
    dbus_rddata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    dbus_rdstall : out STD_LOGIC;
    dbus_hitinvalidate : in STD_LOGIC;
    dbus_ivaddr : in STD_LOGIC_VECTOR ( 31 downto 0 );
    dbus_ivstall : out STD_LOGIC
  );

end bd_soc_ICache_0_0;

architecture stub of bd_soc_ICache_0_0 is
...
attribute X_CORE_INFO of stub : architecture is "ICache,Vivado 2017.1";
begin
end;
