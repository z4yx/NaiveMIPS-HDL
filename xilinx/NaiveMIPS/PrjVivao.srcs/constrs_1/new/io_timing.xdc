...
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -2.000 [get_ports base_ram_be[*]]
...
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -2.000 [get_ports ext_ram_be[*]]
