...
set_output_delay 0 -clock clk_in [get_ports [list NUM_A_G*  NUM_CSn*  gpio0* txd MII_rst_n bicolor* ddr3_reset_n]]
set_false_path -to   [get_ports [list NUM_A_G*  NUM_CSn*  gpio0* txd MII_rst_n bicolor* ddr3_reset_n]]

set_input_delay 0 -clock clk_in [get_ports [list gpio1*  rst_in_n rxd]]
set_false_path -from [get_ports [list gpio1*  rst_in_n rxd]]
