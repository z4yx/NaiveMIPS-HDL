...
set_input_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay 4.2 [get_ports {base_ram_data[*]}]
...
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports {ext_ram_addr[*]}]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports {ext_ram_data[*]}]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports {ext_ram_data[*]}]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports base_ram_ce_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports base_ram_ce_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports base_ram_be[*]]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports base_ram_be[*]]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports base_ram_oe_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports base_ram_oe_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports base_ram_we_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports base_ram_we_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports ext_ram_ce_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports ext_ram_ce_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports ext_ram_be[*]]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports ext_ram_be[*]]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports ext_ram_oe_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports ext_ram_oe_n]
set_output_delay -clock [get_clocks CLK_OUT2_clk_wiz_v3_6] -min -add_delay -1.800 [get_ports ext_ram_we_n]
