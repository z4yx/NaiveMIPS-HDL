...
set_input_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -max -add_delay 20.000 [get_ports {base_ram_data[*]}]
set_input_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -min -add_delay 2.000 [get_ports {ext_ram_data[*]}]
set_input_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -max -add_delay 20.000 [get_ports {ext_ram_data[*]}]
...
set_output_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -min -add_delay -2.000 [get_ports base_ram_be[*]]
set_output_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports base_ram_be[*]]
...
set_output_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -min -add_delay -2.000 [get_ports ext_ram_be[*]]
set_output_delay -clock [get_clocks VIRTUAL_CLK_OUT2_clk_wiz_v3_6] -max -add_delay 11.000 [get_ports ext_ram_be[*]]
